...
//        CHK_ERR(DDERR_UNSUPPORTED, "DDERR_UNSUPPORTED")
    ...
    CHK_ERR(DDERR_INVALIDPOSITION, "returned when the translation of the overlay on the destionation is no longer legal for that destionation.")
    ...
    CHK_ERR(DDERR_CANTCREATEDC, "Windows can not Init any more DCs, or a DC was requested for a paltte-indexed surface when the surface had no palette AND the display mode was not palette-indexed (in this case DirectDraw cannot select a proper palette into the DC)")
    ...
    CHK_ERR(DDERR_NOFOCUSWINDOW, "Attempt was made to Init or set a device window without first setting the focus window")
...
// -------------------------------------------------------------
    ...
    CHK_ERR(DXUTERR_CREATINGDEVICE, "An error occurred when attempting to Init a device.")
    CHK_ERR(DXUTERR_RESETTINGDEVICE, "An error occurred when attempting to reset a device.")
    CHK_ERR(DXUTERR_CREATINGDEVICEOBJECTS, "An error occurred in the device Init callback function.")
...
// -------------------------------------------------------------
    ...
    CHK_ERR(XAUDIO2_E_XAPO_CREATION_FAILED, "Failed to Init an audio effect")
